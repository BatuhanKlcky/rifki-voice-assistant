...
main.py
-------
RIFKI uygulamasının giriş noktası.
...
def main():
    ...
    if all_ok:
        print("\nRIFKI çevrimiçi. Size nasıl yardımcı olabilirim?\n")
    else:
        print(
            "\nRIFKI bazı eksik bileşenlerle başlatılıyor. "
...
if __name__ == "__main__":
    try:
        ...
        print(f"[KRİTİK HATA] RIFKI başlatılamadı: {e}")
        sys.exit(1)